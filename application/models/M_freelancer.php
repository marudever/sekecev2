<?php 
	...
	class M_freelancer extends CI_Model
	{
		...
		public function get_where_f($wherefr)
		{

			$this->db->select('*, freelancer.id AS ID, freelancer.nama AS NAMA, freelancer.deskripsi AS desk');
			return $this->db->get_where('freelancer', $wherefr);
