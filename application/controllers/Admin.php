<?php 
	...
	class Admin extends CI_Controller
	{
		...
		{	
			...
			$data['data_f'] = $this->M_freelancer->get_where_custom($where)->row();

			$wherefr = array(
				'id' => $data['data_f']->id
			);
			$data['free'] = $this->M_freelancer->get_where_f($wherefr)->result();
			...
			$wheref = array(
				'freelancer' => $data['data_f']->id
			);
			$data['list'] = $this->M_order->get_where_f($wheref)->result();
			$data['jumlah_artikel'] = $this->M_order->get_where_f($wheref)->num_rows();
