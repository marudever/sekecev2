<?php 
	...
	class User extends CI_Controller
	{
		...
		public function lp2()
		{
			...
			// Data Artikel
			$data['artikel'] = $this->M_artikel->get_join('kategori', 'freelancer', '10')->result();
			...
			// Data Rank Freelancer
			$data['rank'] = $this->M_user->get_join('5')->result();
