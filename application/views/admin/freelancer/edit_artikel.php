					...
					<div class="card-body">
						...
						<?= form_open_multipart('edit/artikel/'.$artikel->id); ?>
							...
							<div class="row">
								<div class="col-md-4">
									<h5>Image 1:</h5>
									<input type="hidden" name='gambar_sekarang1' value='<?= $artikel->gambar1 ?>'>
									<img src="<?= base_url('assets/thumbnail/'.$artikel->gambar1) ?>" class="img-fluid">
									<input type="file" name="foto1" class="form-control">
								</div>

								<div class="col-md-4">
									<h5>Image 2:</h5>
									<input type="hidden" name='gambar_sekarang2' value='<?= $artikel->gambar2 ?>'>
									<img src="<?= base_url('assets/thumbnail/'.$artikel->gambar2) ?>" class="img-fluid">
									<input type="file" name="foto2" class="form-control">
								</div>

								<div class="col-md-4">
									<h5>Image 3:</h5>
									<input type="hidden" name='gambar_sekarang3' value='<?= $artikel->gambar3 ?>'>
									<img src="<?= base_url('assets/thumbnail/'.$artikel->gambar3) ?>" class="img-fluid">
