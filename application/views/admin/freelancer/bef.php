                    ...
                    <div class="card-body" style="background-color:#eeeeee;">
                        ...
                        <?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="wa" placeholder="Nomor Whatsapp" required>
                            </div>

                            <div class="form-group">
                                <label>Instagram</label>
                                <input type="text" class="form-control" name="ig" placeholder="Instagram" required>
                            </div>
