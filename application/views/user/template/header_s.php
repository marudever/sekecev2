  ...
  <div class="modal-dialog modal-lg modal-side modal-top-right mt-5" role="document">
    <div class="modal-content" style="background-color:#f6c90e;">
      ...
      <div class="d-flex flex-column">
        ...
        <?php endif; ?>
        <a class="p-2 btn btn text-left" href="<?= base_url("order") ?>" style="font-family: 'Poppins', sans-serif;background-color:#eeeeee;color:#303841;"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Your Order</a>
