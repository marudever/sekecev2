    ...
    <div style="padding-left:15%;padding-right:15%;">
        ...
        <div>
            <div class="row" style="margin-bottom:-2%;">
                <div class="col">
                    <p>List /<a href="<?= base_url('list/design') ?>"> Design </a>/<a href="<?= base_url('design/logo') ?>"> Logo </a></p>
                </div>
            </div>
    ...
    <div>
        ...
        <div class="col mb-4">
            ...
            <div class="view overlay">
                ...
                alt="Card image cap">
                <a href="<?= base_url('pages/'.$art->slug) ?>">
            ...
            <div class="card-body">
                ...
                <div>
                    <!--Title-->
                    <p class="card-title">Rp. <?= $art->harga ?> | By <?= $art->nama ?></p>
                </div>
