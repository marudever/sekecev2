...
$route['order/(:num)/(:any)/(:any)/(:any)'] = 'artikel/order/$1/$2/$3/$4';
$route['order']                             = 'ordering/index';

// Payment
$route['payment_clear/(:num)']  = 'ordering/payment_clear/$1';
$route['pay/(:num)']            = 'ordering/paying/$1';
$route['payment_wait/(:num)']   = 'ordering/payment_wait/$1';
$route['payment_acc/(:num)']    = 'ordering/payment_acc/$1';
$route['payment_done/(:num)']   = 'ordering/payment_done/$1';


// Guest
$route['pages/(:any)']	    = 'user/ke_detail/$1';
